...
export class ServiciosPage implements OnInit {
  ...
  // ==================== CABALLEROS (9 tarjetas por filtro) ====================
  serviciosCaballerosCorte = [
    { nombre: 'Barba', descripcion: 'Corte personalizado con asesoría y lavado.', precio: 13000, duracionMinutos: 15, imagen: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIGJP8QVTdvHPx4EmYmBu5iEHb8EX92ta_MOYfYFbEwxwU5gGIyGFwemE&s=10' },
    { nombre: 'Corte + Limpieza Facial', descripcion: 'Desvanecido perfecto con acabados a navaja.', precio: 70000, duracionMinutos: 50, imagen: 'https://cdn.atrapalo.com/o/event/294334/1017525.jpg?auto=avif&width=1280&quality=75' },
    { nombre: 'Corte + Barba y Rasurado Con Espuma + Exfoliacion Facial', descripcion: 'Estilo formal para el entorno corporativo.', precio: 60000, duracionMinutos: 50, imagen: 'https://www.matizhombres.cl/wp-content/uploads/2024/04/5ed688445c5f2.jpg' },
  ...
  serviciosCaballerosCejas = [
    ...
    { nombre: 'Cejas Con Hilo', descripcion: 'Definición duradera sin irritación.', precio: 12000, duracionMinutos: 15, imagen: 'https://mastercejas.com/wp-content/uploads/2019/05/DEPILACI%C3%93N-CON-HILO-EN-CEJAS-HOMBRE-1030x747.jpg' },
    { nombre: 'Cejas Con Cuchilla', descripcion: 'Combo de simetría facial completa.', precio: 5000, duracionMinutos: 30, imagen: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4VziZsiLKhpC-7TanyZK4GwLtyXruHsimw_yOEvOT_hvaqptTRlG5-1EP&s=10' },
  ];

  // ==================== DAMAS (9 tarjetas por filtro) ====================
  serviciosDamasCabello = [
    ...
    { nombre: 'Botox Capilar Rejuvenecedor', desc: 'Devuelve la vitalidad y brillo al cabello maltratado.', precio: 110000, duracionMinutos: 90, imagen: 'https://www.capilarea.com/wp-content/uploads/2023/12/botox-capilar.jpg' },
